...
INPUT=$CODE/atac-seq-pipeline-test-data/scripts/ENCSR356KRQ_disable_tn5_shift.json
WF_OPT=$CODE/atac-seq-pipeline/workflow_opts/docker.json
BACKEND_CONF=$CODE/atac-seq-pipeline/backends/backend.conf
BACKEND=Local

mkdir -p ENCSR356KRQ_disable_tn5_shift && cd ENCSR356KRQ_disable_tn5_shift
