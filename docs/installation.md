# NCBI-Hackathons/ATACFlow Installation

To start using the NCBI-Hackathons/ATACFlow pipeline, there are three steps described below:
...
This pipeline itself needs no installation - NextFlow will automatically fetch it from GitHub if `NCBI-Hackathons/ATACFlow` is specified as the pipeline name.
...
```bash
wget https://github.com/NCBI-Hackathons/ATACFlow/archive/master.zip
unzip master.zip -d /my-pipelines/
cd /my_data/
nextflow run /my-pipelines/ncbihackathons-atacflow-master
```
